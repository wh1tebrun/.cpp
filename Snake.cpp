...
void drawSnake(int color) { 
  ...
  drawPixel(previousHeight, previousWidth, COLOR_PAIR(3));
  drawPixel(currentHeight, previousWidth, COLOR_PAIR(3));
  drawPixel(previousHeight, currentWidth, COLOR_PAIR(3));

  drawPixel(currentHeight, currentWidth, color); 
